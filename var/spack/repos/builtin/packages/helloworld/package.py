...
class Helloworld(MakefilePackage):
    ...
    url = "https://github.com/august-knox/helloWorld/archive/refs/tags/v1.6.tar.gz"
    ...
    version("1.6", sha256="e11e61f993cc4f1abd6618ebbf94b0cde8f370b41b3a0703b901517be940996f")
